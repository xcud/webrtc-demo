...
var reshapeThumbs = [
    function(parentw, parenth) {
        ...
        if( activeBox > 0 ) {
            ...
            setSharedVideoSize(width, height)
            switch(connectCount) {
                case 0:return reshapeToFullSize(width, height);
                case 1:return reshape1of2(width, height);
                case 2:return reshape1of3(width, height);
                case 3:return reshape1of4(width, height);
            }
        }
    },
    function(parentw, parenth) {
...
function appInit() {
	...
	if(!inIframe()) {
		document.body.style.backgroundImage = 'url("http://az736501.vo.msecnd.net/cdn/space-station.jpg")';
...
function appConnect() {
    ...
    easyrtc.easyApp("easyrtc.multiparty" + roomName, "box0", ["box1", "box2", "box3"], loginSuccess);
